...
IMAGE_HEIGHT = 720
SEED = 10000
PROMPT_SUFFIX = "make sure the silhouttes have no eyes, no nose , no ears,no mouth,just blank silhoutte ,the overall inage should be polished with gradients in between colours making a smooth view, "
