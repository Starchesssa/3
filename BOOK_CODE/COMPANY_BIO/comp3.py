...
4. Make the script to be divided into parts, intro should be less than 1.5 minutes , outro same should be less than 1.5 minites  long, the body is didvided so each body part should not exceed 3.5 minutes -4 minutes ,it shoild be less than that .
...
12. also make a outro , the outro should be similar to a youtube outro , and tell them to subscribe , also , link of the audio book is avaialble for free for new users audible, and the book also is available in description .
