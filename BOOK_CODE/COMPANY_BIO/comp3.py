...
def build_prompt(book_info, sample_years=None, chapters_reference=None):
    ...
    prompt = (
        ...
        "8. Make the timeline causal: show how decisions and events in one year led to outcomes in the next years.\n"
        "9. Include short real-world examples and numbers for each major event. When you mention a failure, quantify it. When you mention a recovery, quantify it.\n"
        "10. Each sentence must end with a period ('.').\n"
        "11. Do NOT include intros, outros, chapter lists, or summaries. Do NOT say 'Here's the script'. Return only the narration and KEY LESSON headings inline.\n"
        "12. Ensure the narration reads naturally as a story and is ready to be used as a voiceover for a long-form video or audiobook.\n"
        f"{chapter_note}\n\n"
