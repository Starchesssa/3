...
def build_prompt(book_info, sample_years=None, chapters_reference=None):
    ...
    prompt = (
        f"You are writing a  long book summary script based on the book titled "
        f"'{book_info['title']}' by {book_info['author']} about the company {book_info['company']}.{years_text}\n\n"
        "Requirements and style rules:\n"
        "1.   ."
        "2. use magnetes media youtube narration style and your audience is people who love to become enterpreneurs,ceos, investors,side hustlers etc .\n"
        ...
        "7. use pronouns you,your, yours etc dont use pronoun i or we, cause you didnt read the book youre just narrating .\n"
