...
def build_prompt(book_info, sample_years=None, chapters_reference=None):
    ...
    prompt = (
        ...
        "7. use pronouns you,your, yours etc dont use pronoun i or we , focus on the view more.\n"
        "7. intro should be a hook of the book , hook people attention by the book intro. Do NOT say 'Here's the script'. Return only the narration and KEY LESSON headings inline.\n"
        "9. key lesson must be a headline relevant to the book that will guide through the lesson story.\n"
        "10. each lesson must be more relevant anf must have  exposition, rising action/conflict ,climax ,falling action , resolution , thats how you story tell to enterpresneurs , sidehustlers etc so that they undertand .\n"
        f"{chapter_note}\n\n"
