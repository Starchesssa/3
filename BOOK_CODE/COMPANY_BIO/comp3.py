...
def build_prompt(info):
    return f"""
You are writing a concept based script, script that makes people undertand core concept of the book  , make the  script based on the book titled '{info['title']}' by {info['author']}.
...
2. all headings must be in capital letters including the intor heading , include intro explaining about the intro of the book and reason of the book,where you introduce the book ,the author ,purpose for the book and high light major concepts and events of the book.
3. Make the script to be divided into parts, intro should be less than 150 words , outro same should be less than 150 words long, the body is didvided so each body part should not exceed 500 words ,it should be less than that, overall script should be atleast 4000 words.
4. explain concepts to make people undertand instead of documentary
5. use small letters in the script expect capital letters in the heading 
6. make people undertand main cobcept of the book rsther ghan documentary ..
7. use 2nd and 3rd personal prodnoun dont use 1st personal pronoun 
8. use more statistics and state what actually happened at the comapny , real life events and statistics, tell what actually hapened instead of generic facts 
9. in the intro ,after exaplining the purpose of the book and author etc , make a mini trailer or cliffhanger of what you are going to discuss in the video, the mini trailer must be very key aread of tension ,conflict etc that will make the viewer intrigued, just be like you are making a movie trailer at the intro .and dobt include unnecessary words , just make it simple by explaining book purpose , author and its trailer what will happen 
10. also make a outro , the outro should be similar to a youtube outro , and tell them to subscribe , also , link of the audio book is avaialble for free for new users audible, and the book (ebook/physical) also is available in description, do this also after the into.
11. use more concepts , make people undetand the main message 
